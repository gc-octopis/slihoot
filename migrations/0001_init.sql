-- 0001_init: complete baseline schema.
-- All statements are idempotent (CREATE TABLE IF NOT EXISTS), so applying this
-- against an existing database that already matches the schema is a safe no-op
-- and simply records the version in schema_migrations.
...
CREATE TABLE IF NOT EXISTS live_sessions (
  ...
  current_activity_started_at DATETIME NULL,
